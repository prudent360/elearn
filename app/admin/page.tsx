    ...
    <section className="surface admin-users-card overflow-hidden">
      ...
      <div className="admin-table overflow-x-auto">
        ...
        {visible.map(user => <div key={user.id}>
          <div className="admin-user-row transition-colors hover:bg-[var(--bg-card-hover)]">
