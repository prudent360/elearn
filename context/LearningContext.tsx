...
interface Account {id:string;name:string;email:string;role:'learner'|'instructor'|'admin'}
...
export function LearningProvider({children}:{children:React.ReactNode}) {
 ...
 return <Context.Provider value={{data,account,theme,toggleTheme,savedCourses,enrolledCourses,userNotes,lastLessons,weeklyGoalHours,communityThreads,notificationSettings,workspaceSettings,api,refresh,logout,noteStatus,
