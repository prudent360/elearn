...
const files = ['index.html', 'styles.css', 'data.js', 'app.js', 'catalog.js', 'lesson-content.js', 'learning.js'];
const types = files.map(file => file.endsWith('.html') ? 'text/html' : file.endsWith('.css') ? 'text/css' : 'text/javascript');
